...
int main( int argc, char* argv[] )
{
  ...
  try 
  {
    ...
    for (lid i=0; i< s.nhomes(); ++i)
    {
      ...
      diff_t d_dx( FD_family_f4::instance(), g.stencil[i], XDIM, d.dx() );
      ...
      diff_t d_dy( FD_family_f4::instance(), g.stencil[i], YDIM, d.dx() );
      ...
      diff_t d_dz( FD_family_f4::instance(), g.stencil[i], ZDIM, d.dx() );
